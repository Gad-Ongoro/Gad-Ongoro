...
export default function Projects() {
  const projects = [
    ...
    {
      name: "GoTech",
      description: "Fiverr Client Order ~ Developed a full-stack web application for publishing and monetizing tech articles, using Django (Python) and Next.js (TypeScript). The platform supports secure Firebase authentication (custom tokens and Google OAuth 2.0), subscription-based content access via Stripe, and real-time cookie tracking for user activity.",
      link: "https://dataspritz.vercel.app/",
