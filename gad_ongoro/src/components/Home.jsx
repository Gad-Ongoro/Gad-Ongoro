				...
				<div className="about" id="about">
					...
					<div className="overview">
						<div>
							...
							<code>My back-end proficiency includes Python, PHP, and Node.js, utilizing frameworks like Flask, Express, and Django. I'm also experienced in database management using SQL and NoSQL databases.</code>

							<code> I'm adept at version control systems like Git and deployment on cloud platforms such as AWS, using Docker to enable seamless containerization and deployment of applications, strong problem-solving skills, and a commitment to writing clean, efficient, and scalable code. I've proven my ability to collaborate in cross-functional teams, delivering high-quality software solutions.</code>                             
						</div>
					</div>
